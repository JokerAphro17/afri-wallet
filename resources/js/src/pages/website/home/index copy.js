    ...
    return (
        <div className="sections_group">
            <div className="entry-content">
                <div className="section mcb-section dark has-video bg-cover" style={{paddingTop:'12vh', paddingBottom:'0px', backgroundRepeat:'no-repeat', backgroundPosition:'left top'}}>
                    <Carousel>
                        <Carousel.Item >
                ...
                {/* <div className="section mcb-section dark" id="first" style={{paddingTop:'50px', paddingBottom:'0px', backgroundColor:'#a18e72'}}>
                    <div className="section_wrapper mcb-section-inner">
                        <div className="wrap mcb-wrap one valign-top clearfix">
                            <BannerBar
                                title={'Some important news here'}
                                withBg={false}
                                btnTxt={'View more details'}
                                urlBtn={''}
                            />
                        </div>
                    </div>
